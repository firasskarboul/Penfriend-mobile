                    ...
                    >
                        ...
                        >
                            ...
                            <View style={{ width: 80, justifyContent: 'center', alignItems: 'center', margin: 10 }}>
                                <Text style={{ color: '#40ff33', fontSize: 40, fontWeight: 'bold', fontFamily: 'WTR' }}>Age</Text>
                            </View>
                            <View style={{
                                flexDirection: 'row'
                            }}>
                            ...
                            <View style={{ width: 150, justifyContent: 'center', alignItems: 'center', margin: 10 }}>
                                <Text style={{ color: '#ffa932', fontSize: 40, fontWeight: 'bold', fontFamily: 'WTR' }}>Kid Photo</Text>
                            </View>
                            <TouchableOpacity style={{
                                justifyContent: 'center',
                                alignItems: 'center'
